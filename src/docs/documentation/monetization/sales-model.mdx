...
Setting a `Price Point` alone does not guarantee that your book
is behind a paywall. It just says that your book is premium content. The content itself is still open for anyone to read and share.

Some writers prefer to take this path by leaving their paid work(s)
open with a trust and hope that community will be happy to pay. To
lock the content itself use the `Page Marker`
