...
[Bubblin](https://bubblin.io)—The Binge Reader.
...
The Superbook format also draws a lot from existing e-book formats and modern day front-end techniques
of the web. It adheres to web accessibility guidelines as per WCAG 2.1 (2018) though there are some areas
where the challenges of the longform creep up over and above the coverage of WCAG. In general the path ahead
for Superbooks will be to follow the [Priority of Constituencies](https://www.w3.org/TR/html-design-principles/#priority-of-constituencies) closely and test every fundamental issue of state, usability and design principles from a codex standpoint.
