---
name: Best Practices
route: /docs/practices
parent: Documentation
menu: General
---
# Best practices

A bunch of goodies and "no good" when you are baking a new Superbook.
...
5. **Page numbering**
	+ Enable displaying [page numbers](/docs/numbering) on textbooks or larger body of texts.
